#This script takes a rMATS SE output file, a genome sequence fasta file, and a motif to search for.
#Optionally, it can also take another rMATS output file that contains events you want to "mask".
#The motif can either be a kmer or a regular expression.

#For the analyses of motifs near LS2-sensitive exons, the rMATS input table was
#rMATS/GFPvsWT/MATS_output/SE.MATS.ReadsOnTargetAndJunctionCounts.prepped.txt
#This file itself was produced from rMATS/GFPvsWT/MATS_output/SE.MATS.ReadsOnTargetAndJunctionCounts.txt
#using rMATS_preptable.py to add some columns and split others.

#The motif used for analysis of LS2 binding sites was GG[ATCG]GG[ATCG]G.

#This will output a list of motif locations in each sequence (motiflocations.txt). Sequences that do not contain a 
#motif at all will have a motif location of 1000.

#Tested with the following module versions:
#biopython 1.66
#pandas 0.24.2
#numpy 1.16.4
...
def iteratefastas(motif):
	...
	bigdf.to_csv('motiflocations.txt', sep = '\t', index = False)
